...
public class QuickSort {
	 ...
	 * sub array so that each element in the left sub array is less than or equal to
	 * pivot and each element in the right sub array is greater than or equal to
	 * pivot
	 */
